...
public interface RequestListenerNotifier {
     ...
     * @param listeners a set of {@link RequestListener}. Only instances of
     ...
     *
     * @param request   a given request.
     * @param listeners a set of {@link RequestListener}.
     * @param <T>       generic
     */
     ...
     *
     * @param request   a given request.
     * @param listeners a set of {@link RequestListener}. Only
